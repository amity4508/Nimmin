              ...
              <div className="w-full z-0 max-sm:w-full  max-sm:px-5 text-white  max-sm:order-2 ">
                ...
                <div className="relative lg:left-[-120px] md:left-[0px] xl:p-4 rounded-3xl xl:pl-[150px] lg:pl-[130px]  md:pl[0px]  shadow-md bg-green-200 bg-opacity-5  max-sm:pt-[80px]  max-md:pt-[80px] md:mt-0  max-md:top-[-140px] max-lg:top-[-140px] md:pt-[80px] pb-[20px] ">
                  <h1 className="mt-4  px-4 text-sm">
                    At Nimmin, We strongly believe that, it is not the “Mother
                    nature that needs to be changed. But instead it is the
                    “Mankind nature” which has become much more devastating and
                    needs an immediate makeover. This is not just imperative but
                    essential for usto change the way we live and aspire to
                    triumph as species. This lead us to our visions which is
                    undoubtedly the need of the hour.
                  </h1>
                  <h1 className="mt-4  px-4 text-sm">
                    {" "}
                  ...
                  <h1 className="mt-4  px-4 text-sm">
                    We introduce ourselves as an organization where every
                    person, product and process exists to accentuate sustainable
                    living. In other words, we make products and services which
                    are “Basic Needs”, “Healthier”, “Safer”, “Smarter”,
                    “Desirable” and most of all “ Highly Sustainable” for future
                    generations.{" "}
                  </h1>
    ...
    <div className="flex justify-center">
      <div className="container offringCompo3  bg-white flex max-lg:flex-col  mt-10 px-4 max-sm:gap-8 sm:gap-8">
        <div className="compo3-left lg:w-1/2 sm:w-full  max-md:w-full justify-center">
          <div className="flex justify-center">
            <img
              className="md:h-[400px] md:w-[400px]   xl:h-[400px] xl:w-[400px] rounded-full max-sm:h-[380px] max-sm:w-[380px] max-md:h-[350px] max-md:w-[350px]"
              src={product1left}
              alt=""
            />{" "}
          </div>
        ...
        <div className="container compo3-right lg:w-1/2 max-sm:w-full max-md:w-full max-lg:w-full">
          <div className="flex gap-0 items-center xl:justify-start lg:justify-center md:justify-center   max-md:flex-col ">
            <div className=" z-10  ">
              <img
                className="h-[300px] sm:w-[100%] md:max-w-[330px] rounded"
                src={product1}
                alt=""
              />
            </div>
            <div className=" text-gray-700 max-sm:py-3 md:w-[220px] md:h-[220px] rounded-full outline2  relative right-[30px]   flex md:items-center  max-sm:items-center [50px]">
              <h2 className="pName max-sm:text-3xl sm:text-3xl max-sm:mt-3 sm:mt-3 md:mt-0 md:text-base z-10 ml-[35px] font-semibold">
                {" "}
                Vermicompost{" "}
              </h2>
            </div>
          ...
          <div className="py-2">
            <p>
              Nimmin Organic Vermicompost Fertilizer for plants and home
              gardening 2 Kg - Plant based vermi compost manure - 100% Organic
              Fertilizer Enriched with all essential nutrients. Growth Promoter
              - Encourages optimal plant growth by offering vital nutrients,
              Immunity Booster - Reduce privalance of agriculture illnesses{" "}
            </p>
            <h1 className="text-green-600 lg:text-end max-sm:text-start font-semibold">
              Learn More >>
            </h1>
          </div>
        </div>
    ...
    <div className="flex justify-center">
      <div className="container offringCompo3  bg-white flex max-lg:flex-col  mt-10 px-4 max-sm:gap-8 sm:gap-8">
        ...
        <div className="container compo3-right lg:w-1/2 max-sm:w-full max-md:w-full max-lg:w-full">
          ...
          <div className="py-2">
            <p>
              Nimmin Housekeeping Brush Fiber Wet and Dry Multi use Brush - Flat
              and Strong Fiber for Best Result - Ergonomic Handle and Light
              Weight. Works in Dry & Wet Conditions, High Quality cleaning
              Brooms & Brushes.
            </p>
            <h1 className="text-green-600 lg:text-end max-sm:text-start font-semibold">
              Learn More >>
      ...
      <div className="container offringCompo3  bg-white flex max-lg:flex-col  mt-10 px-4 max-sm:gap-8 sm:gap-8">
        ...
        <div className="container compo3-right lg:w-1/2 max-sm:w-full max-md:w-full max-lg:w-full">
          <div className="flex gap-0 items-center xl:justify-start lg:justify-center md:justify-center   max-md:flex-col ">
            ...
            <div className=" text-gray-700 max-sm:py-3 md:w-[220px] md:h-[220px] rounded-full outline2  relative right-[30px]   flex md:items-center  max-sm:items-center [50px]">
              <h2 className="pName max-sm:text-3xl sm:text-3xl max-sm:mt-3 sm:mt-3 md:mt-0  md:text-base z-10 ml-[40px] font-semibold ">
                {" "}
                Liquid Poshan{" "}
              </h2>
            </div>
          ...
          <div className="py-2">
            <p>
              Lazy Gardener Liquid Poshan For Plant Food |Growth, Root Boost &
              Plant Tonic Combo Plant Care Kit for Plant indoor Outdoor Home
              Garden| Plant Food Fertilizer for Green, Flowering Plants Perfect
              for all types of gardens, whether you have plants in pots or in
              the ground.
            </p>
            <h1 className="text-green-600 lg:text-end max-sm:text-start font-semibold">
              Learn More >>
