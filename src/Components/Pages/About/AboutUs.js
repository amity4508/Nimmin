  ...
  return (
    <>
      <section className="AboutUs">
        ...
        {/* liquid poshan  */}
        <div
          className=" mt-0 xl:px-24 md:px-24 sm:px-5 py-8 bg-white relative "
          style={{
        ...
        <div className="aboutComp2 flex max-sm:flex-col sm:flex-col max-md:flex-col lg:flex-row   items-center gap-5  ">
          <div className="lg:w-4/6 sm:w-full md:w-full max-sm:w-full max-sm:px-5   max-sm:order-2 sm:order-2 text-white ">
            <h1 className="text-xl ">
              ...
              Fertilizer Enriched with all essential nutrients - 2 Pack (1Kg
              Each)
            </h1>
            <div className="mt-5">
              <ul className=" list-disc px-5">
                ...
                <li>
                  Prepared using organic waste and dung in a specific proportion
                </li>
                <li>
                  Soil Enhancer - Enhance soil quality, Structure and texture
                  for optimum absobrtion of nutrients
                </li>
                <li>
                  Natural catalyst - Improves the Water holding capacity of soil
                  that helps moister retention
                </li>
                <li>
                  Yield Multiplier - Aids in plant output and seed germination
                </li>
                <li>
                  Super Organic - Encourage Healthy living by creating chemical
                  free bio organic food
                </li>
                <li>
                  Growth Promoter - Encourages optimal plant growth by offering
                  vital nutrients
                </li>
                <li>
                  Growth Promoter - Encourages optimal plant growth by offering
        ...
        <div className="aboutComp2 flex max-sm:flex-col items-center gap-5  ">
          <div className="w-4/6 max-sm:w-full max-sm:px-5 text-white  max-sm:order-2 ">
            <h1 className="text-white text-xl">
              ...
              &amp; Plant Tonic Combo Plant Care Kit for Plant indoor Outdoor
              Home Garden| Plant Food Fertilizer for Green, Flowering Plants
            </h1>
            <div className="mt-5 px-5">
              <ul className=" list-disc text-white">
                <li>
                  {" "}
                  Contains a unique combination of three specialized liquids
                  that work together to restore and maintain the soil ecosystem
                  for your plants.
                </li>
                <li>
                  Each liquid is made from natural and eco-friendly ingredients,
                  ensuring that it is safe for your plants and the environment.
                </li>
                <li>
                  Perfect for all types of gardens, whether you have plants in
                  pots or in the ground.
                </li>
                <li>
                  Easy to use - simply mix the liquids as per the instructions
                  and apply to your soil regularly.
                </li>
                <li>
                  The Plant Care Kit by Lazy Gardener is a revolutionary
                  solution that helps you create a balanced ecosystem for your
                  plants, just like in nature.
                </li>
              </ul>
            </div>
          </div>
          <div className="w-3/6 max-sm:w-full max-sm:order-1 z-inde">
            <div>
              <img
                className="xl:h-[390px] xl:w-[400px] max-sm:h-[300px] max-sm:w-[300px]  rounded-full mx-auto"
                src={liquidType3_1}
